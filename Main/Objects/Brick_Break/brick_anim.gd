...
func set_frames() -> void:
	...
	tileframes.push_back([4,8,false,false,true])
	frames.append_array(tileframes)
	tileframes.clear()
	tileframes.push_back([4,8,true,false,true])
	frames.append_array(tileframes)
	tileframes.clear()
	tileframes.push_back([4,8,false,true,true])
	frames.append_array(tileframes)
	tileframes.clear()
	tileframes.push_back([4,8,true,true,true])
	frames.append_array(tileframes)
	tileframes.clear()
## END of set_frames
...
func editor_sprite() -> void:
	var tileframes: Array
	tileframes.push_back([4,8,false,false])
